...
10. **State PUC/PSC dockets: thirty-one states down, 19 to go, each with
    ...
    `nePrbDockets.ts`, `laPscDockets.ts`, and `alPscDockets.ts` are all plain-HTTP-fetch sources, not scraping
