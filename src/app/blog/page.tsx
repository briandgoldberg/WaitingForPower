...
import { PredictionsLaunchPreview } from "@/components/blog/previews/PredictionsLaunchPreview";
...
const PREVIEW_COMPONENTS: Record<string, React.ComponentType> = {
  "predictions-for-agents-and-humans": PredictionsLaunchPreview,
    ...
    <div className="mx-auto max-w-3xl w-full px-4 sm:px-6 py-6 flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-[var(--muted)] mt-0.5">
          Analysis and findings from WaitingForPower&rsquo;s live dataset.
        </p>
      </div>
