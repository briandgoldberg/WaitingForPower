// Hand-curated "Dirtiest Projects" list — see /dirtiest. This project's
// schema has no emissions/CO2 field (see taxonomies.ts's ZERO_CARBON_FUELS
...
// it was screened as. Two co-located gas plants (Sandow Lakes, Lincoln Land)
// are each built as two separate generating units with their own docket
// rows in this tracker — listed once here, at one representative unit's
// slug, with the real combined capacity noted in the blurb, rather than
// shown twice for what's one physical project.
